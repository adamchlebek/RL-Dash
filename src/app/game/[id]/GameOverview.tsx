  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="col-span-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="text-4xl font-mono">vs</div>
      ...
      {["blue", "orange"].map((team) => {
        const teamData =
          gameDetails.teams[team as keyof typeof gameDetails.teams];
        ...
        return (
          <div
            key={team}
            className={`${bgColor} backdrop-blur-sm rounded-xl p-6 border border-zinc-700/50`}
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <h4 className="text-lg font-semibold mb-3">Advanced Stats</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h5 className="font-medium mb-2">Boost</h5>
                    <div className="space-y-1 text-sm">
                  ...
                  <div>
                    <h5 className="font-medium mb-2">Movement & Demos</h5>
                    <div className="space-y-1 text-sm">
                      <p>
                        Distance:{" "}
                        {formatDistance(teamData.stats.movement.totalDistance)}
                      </p>
                      <p>
                        Supersonic Time:{" "}
