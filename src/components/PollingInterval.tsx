  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <input
        ...
        className="bg-zinc-700/50 border border-zinc-600 rounded-md px-3 py-2 text-white w-24 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
      />
    </div>
  );
} 