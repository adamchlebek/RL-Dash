...
export const PlayerStatCard = ({
  ...
  return (
    <div
      className={`bg-zinc-800/50 backdrop-blur-sm p-6 rounded-xl border ${colorClasses[color]} hover:bg-zinc-700/50 transition-all duration-300 hover:scale-[1.02]`}
    >
      ...
      <div className="flex items-center gap-2">
        <span
          className={`text-sm px-3 py-1.5 rounded-full ${colorClasses[color]}`}
        >
          {player}
        </span>
      </div>
