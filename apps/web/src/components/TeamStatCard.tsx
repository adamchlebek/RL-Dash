...
export const TeamStatCard = ({ label, value, players, icon, isWorst }: TeamStatCardProps) => {
  ...
  return (
    <div className={`bg-zinc-800/50 backdrop-blur-sm p-6 rounded-xl border ${isWorst ? 'border-red-500/50' : 'border-yellow-500/50'} hover:bg-zinc-700/50 transition-all duration-300 hover:scale-[1.02]`}>
